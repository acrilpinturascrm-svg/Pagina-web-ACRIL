      ...
      <section className="py-16 bg-gray-50 min-h-screen">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Características de la Línea de Solvente</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: ACRIL_COLORS.bloodRed50 }}>
                <h3 className="font-semibold text-gray-900">Uso Industrial</h3>
                <p className="text-sm text-gray-600">Formulación para aplicaciones exigentes</p>
              </div>
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: ACRIL_COLORS.chickYellow50 }}>
                ...
                <p className="text-sm text-gray-600">Protección superior contra corrosión</p>
              </div>
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: ACRIL_COLORS.bloodRed100 }}>
                <h3 className="font-semibold text-gray-900">Secado Rápido</h3>
                <p className="text-sm text-gray-600">Menor tiempo de aplicación</p>
              </div>
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: ACRIL_COLORS.chickYellow100 }}>
                ...
                <p className="text-sm text-gray-600">Cada producto para uso específico</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {lineaSolvente.products.map((product: Product) => {
              ...
              // Función para obtener el tamaño de cada producto
              const getProductSize = (productName: string): string => {
                const sizes: Record<string, string> = {
                  'ESMACRIL': '145%',           // Ajusta este valor
                  'ESMACRIL Piscinas': '65%',  // Ajusta este valor
                  'TRAFICRIL Alto Tráfico': '100%', // Ajusta este valor
                  'HIERROCRIL': '100%'          // Ajusta este valor
                };
                return sizes[productName] || '90%';
              };
          ...
          <div className="mt-16 rounded-xl p-8 text-center text-white" style={{ background: `linear-gradient(to right, ${ACRIL_COLORS.bloodRed800}, ${ACRIL_COLORS.chickYellow600})` }}>
            <h3 className="text-2xl font-bold mb-4">¿Proyecto industrial o especializado?</h3>
